In this project, we use Excel for comprehensive data analysis on the 'Bike_buyers.xlsx' dataset. This includes data cleaning, creating pivot tables, and building a dashboard. 
